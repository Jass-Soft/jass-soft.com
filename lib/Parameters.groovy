class Parameters implements Serializable {
    ...
    def getEnvironmentType() {
        ...
        switch(this.jobName) {
            case JobName.DEV_TST || JobName.CTRLM_DEV_TST:
                return [ 'DEV', 'TST']
            case JobName.MT_PPD || JobName.CTRLM_MT_PPD:
                return [ 'MT', 'PPD']
    ...
    interface JobName {
        final String DEV_TST="ACUAnsible/NON-PROD/MDS-ACU DEV Deploy"
        ...
        final String CTRLM_DEV_TST="Test"
        final String CTRLM_MT_PPD="ACUAnsible/NON-PROD/MT PPD Jobs/MDS-ACU MT PPD Deploy"
        final String CTRLM_PROD="ACUAnsible/PROD/MDS-ACU Deploy"
